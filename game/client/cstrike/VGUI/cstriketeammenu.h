...
private:
	...
	vgui::VectorImagePanel *m_pTLogo;
    vgui::VectorImagePanel *m_pCTLogo;
};
...
public:
	...
	virtual void OnTick(); // 【新增】VGUI Tick 更新回调
...
private:
	...
	vgui::Label* m_pTimerLabel;    // 【新增】倒计时显示控件
	vgui::Label* m_pTimerIcon;
    float        m_flAutoJoinTime;
