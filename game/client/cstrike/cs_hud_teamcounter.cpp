...
ConVar cl_teamcounter( "cl_teamcounter", "0", FCVAR_ARCHIVE,
        "Display style: 0 = digital (text only), 1 = avatar (2-column)" );


//-----------------------------------------------------------------------------
// Layout and color constants
//-----------------------------------------------------------------------------
#define TC_MAX_AVATAR_SLOTS 12
#define TC_AVATARS_PER_ROW 6
#define TC_BASE_AVATAR_SIZE 28
#define TC_BASE_SKULL_SIZE 27
...
void CHudTeamCounter::Layout()
{
    ...
    m_iSkullSize    = ScalePx(TC_BASE_SKULL_SIZE);
