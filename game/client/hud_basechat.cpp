...
Color g_ColorTer(234, 209, 138, 96);
Color g_ColorConter(181, 212, 238, 96);
Color g_ColorCt(150, 200, 255, 220);
    ...
    vgui::RichText( parent, panelName )
{
    ...
    m_iBgTextureId = vgui::surface()->CreateNewTextureID();

    vgui::surface()->DrawSetTextureFile( m_iBgTextureId, "vgui/hud/chatline_background", true, false );
...
void CBaseHudChatLine::OnThink()
{
    ...
    if ( m_flBackgroundAlpha != cl_hud_background_alpha.GetFloat() )
    {
        ...
        Color newColor( 12, 12, 12, m_flBackgroundAlpha * 255 );
